...
\cite{stanton2005analysis, breivik2002abstract}. Then, there is a need of constant renewal of the CSPs, which it might be difficult if new threats appear without knowing it in advance (because they are not included in the security policies).
...
demonstrate that it is possible to extend the preformance of what are
